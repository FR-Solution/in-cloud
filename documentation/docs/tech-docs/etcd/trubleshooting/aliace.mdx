...
## 5.1.5.4. Подключение через crictl
...
## 5.1.5.5. Подключение через nsenter
...
## 5.1.5.6. Подключение через kubectl
TODO
