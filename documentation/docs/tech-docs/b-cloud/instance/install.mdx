...
Термин  **«Tenant»** определяет область применения. Хотя каждый может толковать это по-своему, мы предполагаем, что это значение должно быть однимиз следующих четырёх: `«dev»`, `«test»`, `«stage»` или `«prod»`.
<Tabs>
        ...
        <div className="child-block">
          <h4 className="center">Enivironments</h4>
            <CodeBlock language="bash">
              {dedent`
                export KUBERNETES_CLUSTER_NAME="bcloud-k8s-infra"
