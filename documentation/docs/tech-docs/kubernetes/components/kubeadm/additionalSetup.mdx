...
### 5.1.1.2.5.3.2. Настройка ролевой модели
<Tabs groupId="install-type">
...
### 5.1.1.2.5.3.3. Загрузка `kubelet-conf` и `kubeadm-conf` в кластер
<Tabs groupId="install-type">
...
### 5.1.1.2.5.3.4. Загрузка корневых сертификатов в кластер
<Tabs groupId="install-type">
