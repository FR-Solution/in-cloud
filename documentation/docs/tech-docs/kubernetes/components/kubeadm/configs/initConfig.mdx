    ...
    {dedent`
      ...
      apiServer:
        extraArgs:
          ...
          # DEPRECETADE 1.30.4 kubelet-port: "${KUBE_API_ARGS.kubeletServerPort.value}"
          # DEPRECETADE 1.30.4 kubelet-read-only-port: "${KUBE_API_ARGS.kubeletReadOnlyPort.value}"
