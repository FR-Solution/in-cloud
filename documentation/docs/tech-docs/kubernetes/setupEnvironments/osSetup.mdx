...
## 5.1.1.1.1. Переменные окружения узла
...
## 5.1.1.1.2. Изменение имени узла
<CodeBlock language="bash">
{dedent`
...
## 5.1.1.1.3. Загрузка модулей ядра
<CodeBlock language="bash">
{dedent`
...
## 5.1.1.1.4. Настройка Sysctl

:::warning

### 5.1.1.1.4.1. Настройка сети
...
## 5.1.1.1.5. Примененме конфигурации
<CodeBlock language="bash">
{dedent`
    sysctl --system
`}
