...
{`export ETCD_CA_CN="${CERTIFICATES.etcdCA.cname}"
  ...
  export CONTROLLER_MANAGER_CLIENT_CN="${CERTIFICATES.kubernetesControllerManagerClient.cname}"
  export CONTROLLER_MANAGER_CLIENT_CRT_CONF="${CERTIFICATES.kubernetesControllerManagerClient.crtConf}"
  export CONTROLLER_MANAGER_CLIENT_CRT_PATH="${CERTIFICATES.kubernetesControllerManagerClient.crtPath}"
  export CONTROLLER_MANAGER_CLIENT_CSR_PATH="${CERTIFICATES.kubernetesControllerManagerClient.csrPath}"
  export CONTROLLER_MANAGER_CLIENT_KEY_PATH="${CERTIFICATES.kubernetesControllerManagerClient.keyPath}"
  export CONTROLLER_MANAGER_CLIENT_KEY_SIZE=${CERTIFICATES.kubernetesControllerManagerClient.keySize}
  ...
  export SCHEDULER_CLIENT_CN="${CERTIFICATES.kubernetesSchedulerClient.cname}"
  export KUBERNETES_SCHEDULER_CLIENT_CRT_CONF="${CERTIFICATES.kubernetesSchedulerClient.crtConf}"
  export SCHEDULER_CLIENT_CRT_PATH="${CERTIFICATES.kubernetesSchedulerClient.crtPath}"
  export SCHEDULER_CLIENT_CSR_PATH="${CERTIFICATES.kubernetesSchedulerClient.csrPath}"
  export SCHEDULER_CLIENT_KEY_PATH="${CERTIFICATES.kubernetesSchedulerClient.keyPath}"
  export SCHEDULER_CLIENT_KEY_SIZE=${CERTIFICATES.kubernetesSchedulerClient.keySize}
