...
### 5.2.3.1.1.1. Переменные окружения PKI
...
### 5.2.3.1.1.2. Рабочая директория для PKI
<CodeBlock language="bash">
    {dedent`
...
### 5.2.3.1.1.4. Приватные ключи PKI
...
### 5.2.3.1.1.5. Публичные ключи PKI
