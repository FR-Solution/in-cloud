...
### 5.2.3.2.10.1. Переменные окружения PKI
...
### 5.2.3.2.10.2. Рабочая директория для PKI
<CodeBlock language="bash">
    {dedent`
