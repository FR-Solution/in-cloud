...
### 5.1.3.2.12.1. Переменные окружения PKI
...
### 5.1.3.2.12.2. Рабочая директория для PKI
<CodeBlock language="bash">
    {dedent`
