...
### 5.2.3.2.5.1. Переменные окружения PKI
...
### 5.2.3.2.5.2. Рабочая директория для PKI
...
### 5.2.3.2.5.4. Генерация приватного ключа
