...
import K8sCerts                 from '@site/docs/tech-docs/kubernetes/components/kubelet/certs.mdx'
import ETCDCerts                from '@site/docs/tech-docs/kubernetes/components/etcd/certs.mdx'
import KubeAPICerts             from '@site/docs/tech-docs/kubernetes/components/kubeAPI/certs.mdx'
import KubeControllersCerts     from '@site/docs/tech-docs/kubernetes/components/controllerManager/certs.mdx'
import KubeSchedulerCerts       from '@site/docs/tech-docs/kubernetes/components/scheduler/certs.mdx'
import KubeadmJoinCerts         from '@site/docs/tech-docs/kubernetes/components/kubeadm/joinCerts.mdx'
import KubeadmInitCerts         from '@site/docs/tech-docs/kubernetes/components/kubeadm/initCerts.mdx'
