...
import K8sDownloads             from '@site/src/snippets/kubernetes/downloads.mdx'
import K8sSystem                from '@site/src/snippets/kubernetes/system.mdx'
import CertsSchema              from '@site/src/snippets/kubernetes/certs/schema.mdx'

import SetCertsCA               from '@site/src/snippets/kubernetes/setCertsCA.mdx'
import SetCerts                 from '@site/src/snippets/kubernetes/setCerts.mdx'
...
import PhaseKubeadm             from '@site/src/snippets/kubernetes/phaseKubeadm.mdx'
...
import Arch                     from '@site/src/snippets/kubernetes/flowcharts/arch.mdx'
import TopologyInfra            from '@site/src/snippets/kubernetes/flowcharts/topologyInfra.mdx'
...
#### Маркировка ноды и навешивание tain
