...
import K8sCerts                 from '@site/src/snippets/kubernetes/components/kubelet/certs.mdx'
import ETCDCerts                from '@site/src/snippets/kubernetes/components/etcd/certs.mdx'
import KubeAPICerts             from '@site/src/snippets/kubernetes/components/kubeAPI/certs.mdx'
import KubeControllersCerts     from '@site/src/snippets/kubernetes/components/controllerManager/certs.mdx'
import KubeSchedulerCerts       from '@site/src/snippets/kubernetes/components/scheduler/certs.mdx'
import KubeadmJoinCerts         from '@site/src/snippets/kubernetes/components/kubeadm/joinCerts.mdx'
import KubeadmInitCerts         from '@site/src/snippets/kubernetes/components/kubeadm/initCerts.mdx'
